...
return [
    ...
    'attributes' => [
        'body.text' => 'نص الجسم',
        'BodyVariables..value' => 'قيمة المتغير',
        'components.1.type' => 'النوع',
        'whatsapp_account_id' => 'حساب الواتساب',
        'ticket_id' => 'التذكرة',
        'password_confirmation' => 'تأكيد كلمة المرور',
        'message_id' => 'الرسالة',
        'footer.text' => 'نص التذييل',
        'buttons..phone_number' => 'رقم الهاتف',
        'buttons..text' => 'النص',
        'buttons..type' => 'النوع',
        'buttons..url' => 'الرابط',
        'buttons..quick_reply' => 'الرد السريع',
        'header.text' => 'نص الرأس',
        'header.format' => 'التنسيق',
        'category' => 'الفئة',
        'language' => 'اللغة',
        'name' => 'الاسم',
        'description' => 'الوصف',
