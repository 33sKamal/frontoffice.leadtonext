...
function textCircleAnimation() {
    ...
    words.forEach((word) => {
        ...
        ScrollTrigger.create({
            ...
            once: true,
            onEnter: () =>
                circle.style.setProperty("--animation", "text-circle"),
        });
    });
}
    ...
    function initAnimation() {
        setTimeout(function () {
            ...
            setTimeout(() => {
                ...
                const circle = (mask) =>
                    svg.querySelector(`[mask="url(#${mask.id})"]`)
                        .firstElementChild;
...
function initMarquee(e) {
    let t = gsap.utils.toArray(e.wrappers);
    if (t.length) {
        let r = (function e(t, r) {
            (t = gsap.utils.toArray(t)), (r = r || {});
            let n = gsap.timeline({
                    repeat: r.repeat,
                    paused: r.paused,
                    defaults: { ease: "none" },
                    onReverseComplete: () =>
                        n.totalTime(n.rawTime() + 100 * n.duration()),
                }),
                o = t.length,
                i = t[0].offsetLeft,
                s = [],
                ...
                $ = 0,
                u = 100 * (r.speed || 1),
                d = !1 === r.snap ? (e) => e : gsap.utils.snap(r.snap || 1),
                _,
                l,
                f,
                m,
            ...
            for (
                gsap.set(t, {
                    xPercent(e, t) {
                        let r = (a[e] = parseFloat(
                            gsap.getProperty(t, "width", "px"),
                        ));
                        return (
                            (p[e] = d(
                                (parseFloat(gsap.getProperty(t, "x", "px")) /
                                    r) *
                                    100 +
                ...
                (c = t[g]),
                    ...
                    (m =
                        (f = c.offsetLeft + l - i) +
                        a[g] * gsap.getProperty(c, "scaleX")),
                    n
                        .to(
                            c,
                            {
                                xPercent: d(((l - m) / a[g]) * 100),
                                duration: m / u,
                            },
                            0,
                        )
                    ...
                    (s[g] = f / u);
            function x(e, t) {
                (t = t || {}), Math.abs(e - $) > o / 2 && (e += e > $ ? -o : o);
                let r = gsap.utils.wrap(0, o, e),
                    i = s[r];
                return (
                    i > n.time() != e > $ &&
                        ((t.modifiers = {
            ...
            return (
                ...
                r.reversed && (n.vars.onReverseComplete(), n.reverse()),
                n
            );
        })(t, { repeat: -1 });
...
// function playIframe() {
//     ScrollTrigger.create({
//         trigger: ".wizard-video",
//         start: "top bottom",
//         end: "top bottom",
//         once: !0,
//         onEnter() {
//             let t = document.querySelector(".wizard-video");
//             t.setAttribute(
//                 "src",
//                 "https://player.vimeo.com/video/798424591?background=1&loop=1",
//             );
//         },
//     });
// }
// Form
function formSubmit() {
    let e = document.querySelector(".contact-form_main-wrapper"),
        t = e.querySelector("[type='submit']"),
        r = e.querySelector(".b-button__wrap");
