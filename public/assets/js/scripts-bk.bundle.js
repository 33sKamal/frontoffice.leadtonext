            ...
            (n = document.querySelector("#kt_app_sidebar_toggle")),
                ...
                n &&
                    ...
                    i.on("kt.toggle.changed", function () {
                        ...
                        KTCookie.set("sidebar_minimize_state", i.isEnabled() ? "on" : "off", { expires: e });
                    })),
                e && (r = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(r, e) && e.scroll({ top: KTUtil.getRelativeTopPosition(r, e), behavior: "smooth" });
        },
    };
})();
KTUtil.onDOMContentLoaded(function () {
